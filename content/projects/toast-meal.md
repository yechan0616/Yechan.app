...
summary:
  ko: AI로 미리 보는 학교 급식
  en: Preview school meals with AI-generated images.
---

학교 급식 데이터를 기반으로 AI가 식단의 실제 모습을 이미지로 예측해 보여주는 웹 서비스예요. 글자뿐인 식단표 대신 오늘의 급식을 시각적으로 미리 확인할 수 있어요.
...
A web service that uses AI to generate visual previews of school meals from cafeteria menu data. Instead of a text-only menu, students can see what today's lunch will actually look like.
